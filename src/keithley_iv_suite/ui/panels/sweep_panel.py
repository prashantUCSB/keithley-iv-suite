...
class FourPointProbeTab(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        guide_lbl = QLabel(
            ...
            f'Valdes / Smits convention — tip&nbsp;1→4 along probe head:</p>'
            ...
            f'</tr>'
            f'<tr><td>1&nbsp;(outer)</td><td><b>I+</b></td>'
            f'<td>Current SMU &mdash; <b>Hi</b>&nbsp;(sources +I)</td></tr>'
            f'<tr><td>2&nbsp;(inner)</td><td><b>V+</b></td>'
            f'<td>Voltmeter SMU &mdash; <b>Hi</b></td></tr>'
            f'<tr><td>3&nbsp;(inner)</td><td><b>V&minus;</b></td>'
            f'<td>Voltmeter SMU &mdash; <b>Lo</b></td></tr>'
            f'<tr><td>4&nbsp;(outer)</td><td><b>I&minus;</b></td>'
            f'<td>Current SMU &mdash; <b>Lo</b>&nbsp;(sinks current)</td></tr>'
            f'</table>'
            ...
            f'R<sub>transfer</sub>&nbsp;&times;&nbsp;F&nbsp;&asymp;&nbsp;'
            f'4.532&nbsp;&times;&nbsp;R<sub>transfer</sub>&nbsp;&times;&nbsp;'
            f'F&nbsp;[&Omega;/&#9633;]<br>'
