...
class FourPointProbeTab(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        guide_lbl = QLabel(
            ...
            f'<p style="margin:0 0 6px 0; color:{theme.TEXT_SECONDARY};">'
            f'Single-SMU 4-wire Kelvin mode (RSEN ON) &mdash; '
            f'all four probes connect to <b>one instrument</b>:</p>'
            f'<table cellspacing="0" cellpadding="4">'
            f'<tr style="color:{theme.TEXT_MUTED};">'
            f'  <th align="left" style="padding-right:16px;">Tip</th>'
            f'  <th align="left" style="padding-right:16px;">Role</th>'
            f'  <th align="left">Connect to (I+ SMU)</th>'
            f'</tr>'
            f'<tr><td>1&nbsp;(outer)</td><td><b>Force Hi</b></td>'
            f'<td>SMU <b>Output Hi</b>&nbsp;(sources +I)</td></tr>'
            f'<tr><td>2&nbsp;(inner)</td><td><b>Sense Hi</b></td>'
            f'<td>SMU <b>Sense Hi</b>&nbsp;(voltage sense)</td></tr>'
            f'<tr><td>3&nbsp;(inner)</td><td><b>Sense Lo</b></td>'
            f'<td>SMU <b>Sense Lo</b>&nbsp;(voltage sense)</td></tr>'
            f'<tr><td>4&nbsp;(outer)</td><td><b>Force Lo</b></td>'
            f'<td>SMU <b>Output Lo</b>&nbsp;(sinks current)</td></tr>'
            f'</table>'
            f'<p style="margin-top:10px; color:{theme.TEXT_SECONDARY};">'
            f'The SMU forces current through the <b>outer</b> probes (Force terminals) '
            f'and reads voltage from the <b>inner</b> probes (Sense terminals). '
            f'This eliminates contact resistance from the measurement.<br><br>'
            f'<b style="color:{theme.TEXT_PRIMARY};">Signatone SP4</b>: '
            f's&nbsp;=&nbsp;1.016&nbsp;mm&nbsp;(40&nbsp;mil).<br>'
            ...
            f'4.532&nbsp;&times;&nbsp;(V/I)&nbsp;&times;&nbsp;'
            f'F&nbsp;[&Omega;/&#9633;]<br>'
            f'&rho;&nbsp;=&nbsp;R<sub>s</sub>&nbsp;&times;&nbsp;t'
            f'&nbsp;&nbsp;(Ohm&middot;m, if thickness t is entered)</p>'
        )
